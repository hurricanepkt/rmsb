...
<!-- - `altmetric`: Adds an [Altmetric](altmetric dot com) badge (Note: if DOI is provided just use `true`, otherwise only add the altmetric identifier here - the link is generated automatically) -->
